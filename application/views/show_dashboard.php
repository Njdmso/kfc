...
<body>
  ...
  <div class="content">
    ...
    <div class="sidebar">
      <ul class="navbar-nav">
        ...
        <?php if ($user['role'] === 'admin' || $user['role'] === 'manager'): ?>
          <li class="nav-item">
            <a class="sidebar-link" href="<?php echo site_url('productsource'); ?>"><i class="fa fa-plus-square"></i> Productsource</a>
          </li>
        <?php endif; ?>
        ...
        <?php if ($user['role'] === 'admin' || $user['role'] === 'manager'): ?>
          <li class="nav-item">
            ...
            <ul class="sub-nav">
              <a class="sidebar-link" href="<?php echo site_url('product'); ?>"><i class="fa fa-layer-group"></i>
                Invetory</a>
        ...
        <?php if ($user['role'] === 'admin' || $user['role'] === 'accountant'): ?>
          <li class="nav-item">
            ...
            <ul class="sub-nav">
              <a class="sidebar-link" href="<?php echo site_url('pay'); ?>"><i class="fas fa-money-bill"></i> Payment
                Proccessing</a>
              <a class="sidebar-link" href="<?php echo site_url('buy'); ?>"><i class="fa fa-credit-card"></i> Buys</a>
        ...
        <?php if ($user['role'] === 'admin'): ?>
          <li class="nav-item">
            <a class="sidebar-link" href="<?php echo site_url('auditlog'); ?>"><i class="fa fa-flag"></i> Auditlogs</a>
          </li>
        <?php endif; ?>
    ...
    <img
      src="https://www.kfc.com.ph/Content/OnlineOrderingImages/Menu/Category/Carousel/Cheesy%20Italian%20Zinger%20Steak.jpg?v=0.2">
    <img
      src="https://www.kfc.com.ph/Content/OnlineOrderingImages/Menu/Category/Carousel/Fully%20Loaded%20Meal.gif?v=0.2">
