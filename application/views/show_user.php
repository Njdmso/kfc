                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Actions">
                                <button type="button" class="btn btn-primary edit-button" data-toggle="modal"
                                    data-target="#editModal" data-user_id="<?php echo $user['user_id']; ?>"
                                    data-name="<?php echo $user['name']; ?>" data-role="<?php echo $user['role']; ?>"
                                    data-username="<?php echo $user['username']; ?>"
                                    data-password="<?php echo $user['password']; ?> "><i
                                        class="fas fa-edit"></i>Edit</button>
                                <a href="<?php echo site_url('deleteuser/delete/' . $user['user_id']); ?>"
